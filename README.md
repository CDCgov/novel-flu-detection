...
All results can be generated by running `run_all.R`. Additional functions, parameters, and scripts are available in `functions/`, `parameters.R` and `scripts/`, respectively. 


### Additional information

Questions can be directed to Sinead Morris (run7@cdc.gov).
